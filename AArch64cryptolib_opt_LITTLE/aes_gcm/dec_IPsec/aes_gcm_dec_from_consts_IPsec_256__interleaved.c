...
GHASH block X:
    ...
    REV64   ctr_next, res_curr
    PMULL2  t_h, ctr_next, HX
    PMULL   t_l, ctr_next, HX
    INS     t_m.d[0], ctr_next.d[1]
    EOR     t_m.8B, t_m.8B, ctr_next.8B
    PMULL   t_m, t_m, HX_k
    EOR     acc_h, acc_h, t_h
    EOR     acc_l, acc_l, t_l
    EOR     acc_m, acc_m, t_m
    ...
    )
{
    ...
    (
        ...
        "       eor     "output_l", "output_l", "rk14_l"                    \n" // AES block 4k - round 14 low

        "       aese    "ctr1b", "rk8"   \n  aesmc   "ctr1b", "ctr1b"       \n" // AES block 4k+1 - round 8
        "       pmull   "acc_l".1q, "t_m".1d, "h4".1d                       \n" // GHASH block 4k
        "       eor     "output_h", "output_h", "rk14_h"                    \n" // AES block 4k - round 14 high
        ...
        "       pmull2  "acc_h".1q, "t_m".2d, "h4".2d                       \n" // GHASH final-3 block
        "       eor     "output_l", "output_l", "rk14_l"                    \n" // AES final-3 block - round 14 low

        "       aese    "ctr1b", "rk7"   \n  aesmc   "ctr1b", "ctr1b"       \n" // AES final-2 block - round 7
        "       pmull   "acc_l".1q, "t_m".1d, "h4".1d                       \n" // GHASH final-3 block
        "       eor     "output_h", "output_h", "rk14_h"                    \n" // AES final-3 block - round 14 high
