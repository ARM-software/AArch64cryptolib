...
static operation_result_t aes_gcm_dec_192_kernel(uint8_t * ciphertext,
                                          ...
                                          uint8_t * plaintext)
{
    ...
    (
        ...
        "       eor     "output_l", "output_l", "rk12_l"                    \n" // AES block 4k - round 12 low

        "       aese    "ctr1b", "rk8"   \n  aesmc   "ctr1b", "ctr1b"       \n" // AES block 4k+1 - round 8
        "       pmull   "acc_l".1q, "t_m".1d, "h4".1d                       \n" // GHASH block 4k
        "       eor     "output_h", "output_h", "rk12_h"                    \n" // AES block 4k - round 12 high
        ...
        "       pmull2  "acc_h".1q, "t_m".2d, "h4".2d                       \n" // GHASH final-3 block
        "       eor     "output_l", "output_l", "rk12_l"                    \n" // AES final-3 block - round 12 low

        "       aese    "ctr1b", "rk7"   \n  aesmc   "ctr1b", "ctr1b"       \n" // AES final-2 block - round 7
        "       pmull   "acc_l".1q, "t_m".1d, "h4".1d                       \n" // GHASH final-3 block
        "       eor     "output_h", "output_h", "rk12_h"                    \n" // AES final-3 block - round 12 high
