    ...
    uint8_t * tag)                                            //Outputs
{
    ...
    (
        ...
        "       eor     "input_l", "input_l", "rk14_l"                      \n" // AES block 4k+1 - round 14 low

        "       aese    "ctr1b", "rk5"   \n  aesmc   "ctr1b", "ctr1b"       \n" // AES block 4k+1 - round 5
        "       pmull   "acc_l".1q, "res_curr".1d, "h4".1d                  \n" // GHASH block 4k
        "       eor     "input_h", "input_h", "rk14_h"                      \n" // AES block 4k+1 - round 14 high
        ...
        "       aese    "ctr1b", "rk12"  \n  aesmc   "ctr1b", "ctr1b"       \n" // AES block 4k+1 - round 12
        "       aese    "ctr0b", "rk2"   \n  aesmc   "ctr0b", "ctr0b"       \n" // AES block 4k+2 - round 2

        "       aese    "ctr1b", "rk13"                                     \n" // AES block 4k+1 - round 13
        ...
        "       aese    "ctr1b", "rk12"  \n  aesmc   "ctr1b", "ctr1b"       \n" // AES block 4k+3 - round 12
        "       aese    "ctr0b", "rk0"   \n  aesmc   "ctr0b", "ctr0b"       \n" // AES block 4k+4 - round 0

        "       aese    "ctr1b", "rk13"                                     \n" // AES block 4k+3 - round 13
        "       cmp     %[input_ptr], "main_end_input_ptr"                  \n" // LOOP CONTROL
        ...
        "       aese    "ctr1b", "rk12"  \n  aesmc   "ctr1b", "ctr1b"       \n" // AES final-2 block - round 12

        "       aese    "ctr1b", "rk13"                                     \n" // AES final-2 block - round 13
        ...
        "       aese    "ctr1b", "rk12"  \n  aesmc   "ctr1b", "ctr1b"       \n" // AES final block - round 12

        "       aese    "ctr1b", "rk13"                                     \n" // AES final block - round 13
        "       movi    "t_h".8b, #0                                        \n" // surpress further partial tag feed in
        ...
        "       and     "input_h", %[plaintext_length], #127                \n" // bit_length %= 128
        "       mvn     "rk14_h", xzr                                       \n" // rk14_h = 0xffffffffffffffff
        "       sub     "input_h", "input_h", #128                          \n" // bit_length -= 128
        "       mvn     "rk14_l", xzr                                       \n" // rk14_l = 0xffffffffffffffff
        "       neg     "input_h", "input_h"                                \n" // bit_length = 128 - #bits in input (in range [1,128])
        "       and     "input_h", "input_h", #127                          \n" // bit_length %= 128
        "       lsr     "rk14_h", "rk14_h", "input_h"                       \n" // rk14_h is mask for top 64b of last block
        "       cmp     "input_h", #64                                      \n"
        "       csel    "input_l", "rk14_l", "rk14_h", lt                   \n"
        "       csel    "input_h", "rk14_h", xzr, lt                        \n"
        ...
        : "v0",  "v1",  "v2",  "v3",  "v4",  "v5",  "v6",  "v7",  "v8",  "v9",  "v10", "v11", "v12", "v13", "v14", "v15",
          ...
          "x4",  "x5",  "x6",  "x7",  "x9",  "x10", "x11", "x12", "x13", "x14", "memory"
    );
